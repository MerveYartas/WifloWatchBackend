...
{
    /// <inheritdoc />
    public partial class DatabaseDesing : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => new { x.ContentId, x.ContentType });
                    table.ForeignKey(
                        name: "FK_Comments_Movies_ContentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Friendship_Users_UserId2",
                        column: x => x.UserId2,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Likes", x => new { x.ContentId, x.ContentType });
                    table.ForeignKey(
                        name: "FK_Likes_Movies_ContentId",
                        column: x => x.ContentId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SmartFriendsList", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SmartFriendsList_Users_RecommendedUserId",
                        column: x => x.RecommendedUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SmartFriendsList_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SmartFriendsList_RecommendedUserId",
                table: "SmartFriendsList",
                column: "RecommendedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SmartFriendsList_UserId",
                table: "SmartFriendsList",
                column: "UserId");
